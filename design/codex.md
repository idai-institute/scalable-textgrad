...
Learn how to apply this to failing CI runs with the [autofix CI guide](https://developers.openai.com/codex/autofix-ci) and explore the source in the [openai/codex-action repository](https://github.com/openai/codex-action).
